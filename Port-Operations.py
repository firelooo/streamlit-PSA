...
if st.session_state.selected_page == "Overview":
    ...
    with st.container():
        ...
        with col5:
            st.image("port1.jpeg", use_column_width=True)
        
        with col6:
            st.image("container.jpeg", use_column_width=True)
        ...
        html_link = '''
            <a href="http://127.0.0.1:5500/index.html" target="_blank" /*Live server link*/
...
# Layout for Model 1 Analysis
    ...
    with st.container():
        st.header("Analysis")
        st.image("PSA-worldwide-map.png", caption='Worldwide Map', use_column_width=True)
...
# Image Section
    with st.container():
        ...
        with col1:
            st.image("weather-forecast.jpg", caption='live weather forecast', use_column_width=True)

        with col2:
            st.image("calandar.jpg", caption='Singapore Calandar 2024', use_column_width=True)
